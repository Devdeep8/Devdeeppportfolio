...
const IntroSection = () => {
  ...
  return (
    < >
     <div className={`px-1 py-2 top-0 right-0 fixed text-${darkMode ? 'white' : 'black'} `}>
          <input
        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="md:w-3/4">
            <div className="text-center md:text-left">
              ...
              <div className="mt-4">
                <Link href="#about"
                  className={`mx-2 inline-block my-1 py-3 px-8 text-${darkMode ? 'white' : 'black'} border-2 ${darkMode ? " hover:border-white" : ""} border-black font-semibold text-sm rounded-full hover:bg-${darkMode ? 'white ' : 'black'} hover:text-teal-500 hover:brightness-125 transition duration-300`}>
                  Read More
                </Link>
                <Link href="http://linkedin.com/in/devdeep-patidar"
                  className={`inline-block py-3 my-1 px-8 text-${darkMode ? 'white' : 'black'} border-2 border-black font-semibold text-sm rounded-full hover:bg-${darkMode ? 'white' : 'black'} ${darkMode ? " hover:border-white" : ""} hover:text-teal-500 hover:brightness-125 transition duration-300`}>
                  Contact Me
                </Link>
              </div>
            </div>
