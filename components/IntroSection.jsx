...
<label
  className="inline-block pl-[0.15rem] hover:cursor-pointer px-5 py-5"
  htmlFor="flexSwitchCheckDefault">
     {darkMode ? "Light Mode" :"Dark Mode"}
  </label>
  </div>

    <section id="Home" className={`  h-screen scrollspy md:pl-80 md:pt-40 bg-${darkMode ? 'black' : 'white'} text-${darkMode ? 'white' : 'black'}`}>
